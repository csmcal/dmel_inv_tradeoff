...
printf 'An instance of inv_pipe_nohup.sh, running the inv alignment/frequency analysis pipeline on Pool lab servers\n' >> $LOG 2>&1
...
D_mel_ref='../../alignment_software/dmel_ref/DmelRef.fasta'
...
Picard_directory='../../alignment_software/picard-tools-1.79/picard-tools-1.79/'
GATK_directory='../../alignment_software/GenomeAnalysisTK-3.4-46/'
